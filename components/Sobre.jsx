        ...
        <div id='sobre' className='w-full md:h-screen p-2 flex items-center py-16 '>
            <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
                <div className='col-span-2'>
                    <p className='uppercase text-xl tracking-widest text-[#FFAC47] '>Sobre</p>

                    <h2 className='py-4 text-[#F7E2C9]'>Quem é o Samuel? </h2>

                    <p className='py-2 text-[#FBF6EF]'>
                ...
                <div className="w-full h-auto m-auto shadow-xl shadow-[#0B0B09] bg-[#21211C] rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300">
